...
// Industry Icons (reused from your original Navbar)
...
const Industries = () => {
  ...
  return (
    // Added the id="industries" attribute to the section element
    <section id="industries" className="relative py-20 md:py-24 overflow-hidden bg-neutral-950">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {industries.map((industry, index) => (
            ...
            >
              {/* Industry Card - Added h-full and fixed height */}
              <div className="relative overflow-hidden rounded-2xl bg-black border border-white/10 h-full flex flex-col">
                {/* Image Container - Fixed aspect ratio */}
                <div className="relative aspect-[4/5] overflow-hidden flex-shrink-0">
                  <Image
                    src={`/assets/images/industry-${index + 1}.jpg`} // Make sure you have these images
                    alt={industry.name}
                    fill
                ...
                {/* Red Info Box - Added flex-grow to ensure consistent height */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  {/* Icon and Name - Fixed icon size and layout */}
                  ...
                  {/* Description - Fixed line height and text size */}
