...
const CTA = () => {
  ...
  return (
    ...
    <section className="relative py-20 md:py-24 overflow-hidden bg-white dark:bg-neutral-950">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        {/* Red Background Container with Rounded Edges - Stays the same */}
        <motion.div
        ...
        >
          ...
          <div className="relative z-10 text-center">
            {/* Main Headline - Stays the same, works well on red background */}
            <motion.h2
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            {/* Body - Stays the same, works well on red background */}
            <motion.p
            ...
            {/* CTA Buttons - Stays the same, works well on red background */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            {/* 2. Update Additional Trust Elements */}
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              transition={{ duration: 0.8, delay: 0.8 }}
              viewport={{ once: true }}
              className="mt-12 pt-8 border-t border-black/20 dark:border-white/20"
            >
              <div className="flex flex-wrap justify-center items-center gap-8">
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-black/20 dark:bg-white/20 rounded-full flex items-center justify-center mr-3">
                    <svg className="w-5 h-5 text-black dark:text-white" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="text-black dark:text-white font-medium">No long-term contracts</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-black dark:text-white font-medium">Results guaranteed</span>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-black dark:text-white font-medium">Quick setup</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      {/* 3. Update Background Pattern opacity */}
